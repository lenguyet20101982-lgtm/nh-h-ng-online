...
// 1. Tách phần logic chính ra một component riêng
...
// 2. Component chính xuất ra sẽ được bọc trong Suspense
export default function ChiTietSanPham() {
  return (
    <div className={styles.container}>
      <Header />
      {/* fallback có thể là một cái Loading spinner hoặc để trống */}
